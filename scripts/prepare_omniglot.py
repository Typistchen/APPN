...
DATA_PATH = "/home/dsz/Documents/cjq/few-shot-master/data"
import sys
...
# 添加项目根目录到 Python 路径
sys.path.append('/home/dsz/Documents/cjq/few-shot-master')
...
def handle_characters(alphabet_folder, character_folder, rotate):
    for root, _, character_images in os.walk(character_folder):
        ...
        for img_path in character_images:
            ...
            if img.dtype == bool:
                # 缩放图像并禁用抗锯齿
                img = transform.resize(img, output_shape, anti_aliasing=False)
            else:
                # 缩放图像并启用抗锯齿
