...
f = open(pathname + '/fc100/splits/test.txt')
...
for each in classes:
    ...
    files = glob.glob(pathname + '/fc100/data/' + each + '/*')
...
f = open(pathname + '/fc100/splits/train.txt')
...
f = open(pathname + '/fc100/splits/val.txt')
